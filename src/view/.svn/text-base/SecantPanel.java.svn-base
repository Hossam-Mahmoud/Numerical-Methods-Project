...
public class SecantPanel extends JPanel {

	JButton start, next, runAll;
	TablePanel tablePanel;
	DrawPanel drawPanel;
	SecantController controller;
	JLabel alabel, blabel;
	JTextField a, b;
	Model model;

	@SuppressWarnings("deprecation")
	public SecantPanel(SecantController controller) {
		super();
		setLayout(null);
		...
		SecantActions action = new SecantActions();
	...
	class SecantActions implements ActionListener {
