...
public class NewtonRaphsonPanel extends JPanel {
	JButton start, next, runAll;
	TablePanel tablePanel;
	DrawPanel drawPanel;
	NewtonRaphsonController controller;
	JLabel alabel;
	JTextField a;
	Model model;

	@SuppressWarnings("deprecation")
	public NewtonRaphsonPanel(NewtonRaphsonController newtonRaphsonController) {
		super();
		setLayout(null);

		this.controller = newtonRaphsonController;
		...
		NewtonRaphsonActions action = new NewtonRaphsonActions();
	...
	class NewtonRaphsonActions implements ActionListener {
