...
public class FalsePositionPanel extends JPanel {

	JButton start, next, runAll;
	TablePanel tablePanel;
	DrawPanel drawPanel;
	FalsePositionController controller;
	JLabel alabel, blabel;
	JTextField a, b;
	Model model;

	@SuppressWarnings("deprecation")
	public FalsePositionPanel(FalsePositionController controller) {
		super();
		setLayout(null);
		...
		FalsePositionActions action = new FalsePositionActions();
	...
	class FalsePositionActions implements ActionListener {
